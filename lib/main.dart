import 'dart:async';
import 'dart:io';
import 'package:feelings_flashcards_for_kids/Screens/HomeScreens.dart';
import 'package:feelings_flashcards_for_kids/utils/constants.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    await OneSignal.shared
        .setAppId("4d92b634-376f-4598-8cac-c6265f6359c2");
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      title: 'Emotions Flashcards For Kids',
